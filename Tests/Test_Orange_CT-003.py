...
driver.find_element(By.CSS_SELECTOR,'div.oxd-grid-2.orangehrm-full-width-grid > div > div > div:nth-child(2) > input').click()
...
driver.find_element(By.CSS_SELECTOR,'div.oxd-table-body > div > div > div:nth-child(1) > div > div > label > span > i').click()
...
driver.find_element(By.CSS_SELECTOR,'.oxd-button--medium.oxd-button--label-danger.orangehrm-button-margin').click()
...
driver.find_element(By.CSS_SELECTOR,'div:nth-child(2) > input').click()
driver.find_element(By.XPATH,'//button[@class="oxd-button oxd-button--medium oxd-button--secondary orangehrm-left-space"]').click()
# nova pesquisa sem funcionario valido

id_pesquisa1 = driver.find_element(By.XPATH,'//span[@class="oxd-text oxd-text--span"]').text
time.sleep(2)
assert id_pesquisa1 == 'No Records Found'
#feito